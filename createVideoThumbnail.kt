...
class CreateVideoThumbnailClass(private val reactContext: ReactApplicationContext) {
    ...
    private class ProcessDataTask(
    ...
    ) : AsyncTask<Void, Void, ReadableMap?>() {
        ...
        override fun doInBackground(vararg params: Void?): ReadableMap? {
            ...
            val headers: Map<String, String> =
                if (options.hasKey("headers")) options.getMap("headers")!!.toHashMap() as Map<String, String> else HashMap<String, String>()
        ...
        override fun onPostExecute(readableArray: ReadableMap?) {
    ...
    companion object {
        fun clearCache(cacheDir: String?, promise: Promise, reactContext: ReactApplicationContext) {
            ...
            val thumbnailDir: String = reactContext.applicationContext.cacheDir.absolutePath + cacheDirectory
